/* eslint-disable linebreak-style,wrap-iife,no-unused-expressions,no-var,prefer-destructuring,eqeqeq,no-return-assign,no-multi-assign,no-param-reassign,no-undef,max-len */
/* ========================================================================
